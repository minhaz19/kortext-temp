...
import deleteDeliveryFulFillmentService from '../../../../services/fulfillment/deleteDeliveryFulfillmentService';
...
const DeliveryData = (props) => {
    ...
    const handleDelete = (id) => {
        swal({
            ...
            if (result) {
                deleteDeliveryFulFillmentService(id)
                    .then(res => {
                        if (res) {
                            swal("Data has been deleted!", {
                                icon: "success",
                            });
                            props.filterDeliveryData(id)
                        }
                    })
            }
        })
